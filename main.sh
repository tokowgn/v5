...
function finish(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/myvpn1/izin/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/myvpn1/izin/main/ip | grep $MYIP | awk '{print $3}')
